...
- [Invidious URL Parameter Scripts](https://github.com/MintMain21/Invidious-URL-Parameters-Userscript) Userscripts for appending URL Parameters to enforce preferences across multiver instances. Works in tandum with Privacy Redirector and Simple Sponsor Skipper. See [here](https://docs.invidious.io/url-parameters/) for more information about URL Parameters. 
