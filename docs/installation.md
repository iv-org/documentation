...
`use_pubsub_feeds: true`: if you are serving your instance on the internet, allow for faster notification of new videos ([detailed explanation](https://github.com/iv-org/invidious/blob/842e9fade58414c606b8d97b5050c5f9c9ab77dd/config/config.example.yml#L430).
