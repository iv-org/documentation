...
Running Invidious requires at least 512MB of free RAM, as long as the post-install configuration is done (We recommend to have at least 2GB installed). Public instances should ideally have at least 4GB of RAM, 2vCPU, a 200 mbps link and 20TB of traffic (unlimited traffic is preferred).
